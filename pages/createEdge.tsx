  ...
  const handleCreate = (event: MouseEvent<HTMLElement>) => {
    ...
    signAndBroadcastMessage
      ...
      .then((resp) => {
        ...
        const message = `Success! Register a obligation of ${edgeAmount}  ${convertFromMicroDenom(
  ...
  return (
    <WalletLoader loading={loading}>
      ...
      <h1 className="text-5xl font-bold my-8">
        Record an obligation, you owe to {PUBLIC_CHAIN_NAME} recipient wallet address:
      </h1>
