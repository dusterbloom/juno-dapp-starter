...
/* feature flags */
export const __POOL_STAKING_ENABLED__ =   process.env.NEXT_PUBLIC_ENABLE_FEATURE_STAKING

export const __POOL_REWARDS_ENABLED__ =   process.env.NEXT_PUBLIC_ENABLE_FEATURE_REWARDS

export const __TRANSFERS_ENABLED__ = process.env.NEXT_PUBLIC_ENABLE_FEATURE_TRANSFERS

export const __DARK_MODE_ENABLED_BY_DEFAULT__ = process.env.NEXT_PUBLIC_DARK_MODE_ENABLED_BY_DEFAULT
